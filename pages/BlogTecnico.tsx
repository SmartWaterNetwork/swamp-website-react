    ...
    <div className="max-w-7xl mx-auto px-4 py-16 animate-in fade-in duration-500">
      <div className="mb-16">
        ...
        <div className="mt-6 text-gray-600 dark:text-gray-400 max-w-4xl text-lg leading-relaxed space-y-4">
          ...
          <div className="bg-swam-primary/5 border-l-4 border-swam-primary p-6 rounded-r-xl">
            <p className="text-sm font-medium">
              Si usted está interesado en participar en el Blog Técnico, por favor envíe su documento a: <a href="mailto:hmbenavides@utpl.edu.ec" className="text-swam-primary font-bold hover:underline">hmbenavides@utpl.edu.ec</a>
            </p>
          </div>
        </div>
      </div>
          ...
          >
            <div className="md:w-2/5 relative overflow-hidden h-64 md:h-auto">
              ...
              <div className="absolute top-4 left-4">
                <span className="bg-swam-primary text-gray-900 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-lg">
                  {post.category}
                </span>
                {post.date && (
            ...
            <div className="p-10 md:w-3/5 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-swam-primary transition-colors leading-tight">
                {post.title}
              </h3>
              <div className="h-1 w-16 bg-swam-primary mb-6 rounded-full"></div>
              ...
              <div className="pt-6 border-t border-gray-50 dark:border-gray-700 mt-auto">
                <button
                  ...
                  className="flex items-center text-swam-primary font-bold text-xs uppercase tracking-widest group-hover:translate-x-2 transition-transform"
                >
                  LEER MÁS
