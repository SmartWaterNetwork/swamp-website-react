          ...
          {selectedProject.mdFile ? (
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700">
                <h4 className="text-sm font-bold uppercase tracking-widest text-swam-primary mb-4">Autores</h4>
        ...
        {filteredProjects.map((project, idx) => (
          ...
          >
            <div className="relative h-64 overflow-hidden">
              ...
              {project.status && (
                <div className="absolute top-4 right-4">
                  <span className={`px-3 py-1 rounded-full text-[10px] font-bold shadow-lg ${project.status === 'FINALIZADO' ? 'bg-green-500 text-white' : 'bg-swam-primary text-white'
                    }`}>
                    {project.status}
                  </span>
                </div>
            ...
            <div className="p-8 flex flex-col flex-grow">
              <span className="text-[10px] font-bold text-swam-primary uppercase tracking-widest mb-2">
