  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-12 relative">
        <span className="absolute -top-6 left-0 w-12 h-1 bg-swam-primary"></span>
      ...
      <section className="mb-16">
        ...
        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-8 border-l-4 border-swam-primary pl-4 uppercase tracking-widest">Objetivos</h3>
        <div className="space-y-6">
          <div className="flex gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 group hover:shadow-md transition-shadow">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-swam-primary/20 text-swam-primary flex items-center justify-center font-bold text-lg">1</div>
          ...
          <div className="flex gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 group hover:shadow-md transition-shadow">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-swam-primary/20 text-swam-primary flex items-center justify-center font-bold text-lg">2</div>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md border-l-4 border-swam-primary relative overflow-hidden group">
          ...
          <h4 className="inline-block bg-swam-primary text-gray-900 text-xs font-bold uppercase px-3 py-1 rounded mb-6">Líneas de Investigación</h4>
          <ul className="space-y-3 relative z-10">
            <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-swam-primary"></span> Sostenibilidad del ciclo urbano y rural</li>
            <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-swam-primary"></span> Gestión Integral del Recurso Hídrico</li>
          </ul>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md border-l-4 border-swam-primary relative overflow-hidden group">
          ...
          <h4 className="inline-block bg-swam-primary text-gray-900 text-xs font-bold uppercase px-3 py-1 rounded mb-6">Campos de Estudio</h4>
